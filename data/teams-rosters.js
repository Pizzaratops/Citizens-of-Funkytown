...
//    6 |  8 | Cook Island Airballers     | Rocket Sascha (bis 2026/27: Micha Wenzel)
...
//   11 | 14 | Juicetown Farmers          | DA FZ            (pausiert)
//   12 | 15 | Lokomotive List            | Steffen Wieting  (pausiert)
//
//  inactive:true = Team ist fuer die laufende Saison raus bzw. noch
//  offen, ob die Liga mit 10 oder 12 Teams spielt. Solche Teams werden
//  auf Home und bei den Beitraegen ausgegraut, zaehlen bei den
//  Beitraegen nicht mit und bekommen keine Spalte im Draft Board. Die
//  Historie behalten sie. Zurueckholen = inactive entfernen, endgueltig
//  raus = Eintrag loeschen (Historie zeigt sie dann ohne Farbe).
// ============================================================
const TEAMS = [
  ...
  { id:6,  name:"Cook Island Airballers",    owner:"Rocket Sascha",     record:"0-0-0", color:"#26c6da", lightColor:"#1a8080" },
  ...
  { id:11, name:"Juicetown Farmers",         owner:"DA FZ",             record:"0-0-0", color:"#ffa726", lightColor:"#b86020", inactive:true },
  { id:12, name:"Lokomotive List",           owner:"Steffen Wieting",   record:"0-0-0", color:"#78909c", lightColor:"#607080", inactive:true },
];
function isTeamActive(t) { return !!t && !t.inactive; }
const ACTIVE_TEAMS = TEAMS.filter(isTeamActive);
